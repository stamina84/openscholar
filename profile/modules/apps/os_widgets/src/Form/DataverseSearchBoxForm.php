...
class DataverseSearchBoxForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $params = []) {
    ...
    $form['#attached']['drupalSettings']['osWidgets']['dataverseIdentifier'] = Xss::filter($params['dataverse_identifier']);
    $form['#attached']['drupalSettings']['osWidgets']['dataverseSearchBaseurl'] = Xss::filter($params['dataverse_search_baseurl']);

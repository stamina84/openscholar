...
/**
 * Class DataverseDatasetWidget.
 *
 * @OsWidget(
 *   id = "dataverse_dataset_widget",
 *   title = @Translation("Dataverse Dataset Widget")
 * )
 */
class DataverseDatasetWidget extends OsWidgetsBase implements OsWidgetsInterface {
  ...
  public function buildBlock(&$build, $block_content) {
    ...
    $build['embed_dataverse'] = [
      '#theme' => 'os_widgets_dataverse_dataset',
      '#js_url' => $js_url,
    ];
  }

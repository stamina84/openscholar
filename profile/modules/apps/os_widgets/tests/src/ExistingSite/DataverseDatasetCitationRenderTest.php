...
/**
 * Class DataverseDatasetCitationRenderTest.
 *
 * @group kernel
 * @group widgets-3
 * @covers \Drupal\os_widgets\Plugin\OsWidgets\DataverseDatasetCitationWidget
 */
class DataverseDatasetCitationRenderTest extends OsWidgetsExistingSiteTestBase {
  ...
  public function testRenderArrayContent() {
    ...
    $block_content = $this->createBlockContent([
      'type' => 'dataverse_dataset_citation',
    ...
    $this->assertSame('os_widgets_dataverse_dataset_citation', $render['embed_dataverse']['#theme']);
    ...
    $this->assertContains('widget=citation', $render['embed_dataverse']['#js_url']);

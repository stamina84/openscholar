 ...
 * )
 */
class RemoveTermsMediaAction extends ActionBase implements ContainerFactoryPluginInterface {

  const TEMPSTORE_KEY = 'cp_taxonomy_remove_terms_media';
  ...
  /**
   * Constructs a new RemoveTermsMediaAction object.
   *

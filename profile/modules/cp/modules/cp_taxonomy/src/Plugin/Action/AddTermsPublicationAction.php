...
/**
 * Apply Taxonomy term to bibcite reference entity.
 *
 * @Action(
 ...
 * )
 */
class AddTermsPublicationAction extends ActionBase implements ContainerFactoryPluginInterface {

  const TEMPSTORE_KEY = 'cp_taxonomy_add_terms_bibcite_reference';
  ...
  /**
   * Constructs a new AddTermsPublicationAction object.
   *

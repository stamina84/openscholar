 ...
 * )
 */
class RemoveTermsPublicationAction extends ActionBase implements ContainerFactoryPluginInterface {

  const TEMPSTORE_KEY = 'cp_taxonomy_remove_terms_bibcite_reference';
  ...
  /**
   * Constructs a new RemoveTermsPublicationAction object.
   *

...
namespace Drupal\os_media\Controller;
 ...
 * of an iframe.
 */
class MediaEmbedIframeController implements ContainerInjectionInterface {
   ...
   */
  public function __construct(RendererInterface $renderer, LoggerInterface $logger, IFrameUrlHelper $iframe_url_helper, MediaEntityHelper $media_helper) {
  ...
  /**
   * Renders an Media Embed resource.
   *
  ...
  public function render(Request $request) {
    ...
    $max_width = $request->query->get('max_width', NULL);
    $max_height = $request->query->get('max_height', NULL);
    ...
    try {
      ...
      $element = [
        ...
        '#media' => IFrameMarkup::create($resource['html']),
        '#cache' => [

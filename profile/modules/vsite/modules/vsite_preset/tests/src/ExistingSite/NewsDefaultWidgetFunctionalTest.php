 ...
 * @group functional
 */
class NewsDefaultWidgetFunctionalTest extends VsiteExistingSiteTestBase {
   ...
   */
  public function testRecentNewsBlock() {
    ...
    $this->assertSession()->pageTextNotContains('LATEST NEWS');
    ...
    $this->assertSession()->pageTextContains('LATEST NEWS');

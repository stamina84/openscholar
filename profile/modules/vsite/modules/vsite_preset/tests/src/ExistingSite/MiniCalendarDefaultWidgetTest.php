...
/**
 * MiniCalendarDefaultWidgetTest.
 *
 * @group vsite
 * @group kernel
 */
class MiniCalendarDefaultWidgetTest extends VsiteExistingSiteTestBase {
  ...
  /**
   * Test Mini Calendar widget is created.
   *
   ...
   */
  public function testMiniCalendarWidgetCreation() {
    ...
    $this->assertEquals('Mini Calendar', $info);
    $this->assertEquals('calendar', $field_view_view);

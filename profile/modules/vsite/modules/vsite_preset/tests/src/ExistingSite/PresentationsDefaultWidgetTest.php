 ...
 * @group kernel
 */
class PresentationsDefaultWidgetTest extends VsiteExistingSiteTestBase {
   ...
   */
  public function testRecentPresentationsValues() {
    ...
    $this->assertEquals('presentation', $type);
    $this->assertEquals('title', $displayStyle);
    $this->assertEquals('sort_newest', $sortedBy);
    $this->assertEquals('Recent Presentations', $widgeTitle);
    $this->assertEquals('Recent Presentations', $info);
  }
